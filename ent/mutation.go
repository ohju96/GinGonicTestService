...
func (m *UserMutation) SetID(s string) {
	m._ID = &s
}

// ID returns the value of the "ID" field in the mutation.
func (m *UserMutation) ID() (r string, exists bool) {
	v := m._ID
	if v == nil {
		return
	}
...
// OldID returns the old "ID" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldID(ctx context.Context) (v string, err error) {
...
func (m *UserMutation) Fields() []string {
	...
	if m._ID != nil {
		fields = append(fields, user.FieldID)
	}
	if m.user_name != nil {
