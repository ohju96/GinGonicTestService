...
func (uu *UserUpdate) SetID(s string) *UserUpdate {
	uu.mutation.SetID(s)
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.ID(); ok {
		_spec.SetField(user.FieldID, field.TypeString, value)
	}
...
// SetID sets the "ID" field.
func (uuo *UserUpdateOne) SetID(s string) *UserUpdateOne {
	uuo.mutation.SetID(s)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.ID(); ok {
		_spec.SetField(user.FieldID, field.TypeString, value)
	}
